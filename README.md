...
business problems you can derive by exploring the data?

# Checkpoint:

This is the main part of the task. Let's see this with the two checkpoints required for analysing the data :

1. Checkpoint [1] -> As a business manager, try to find out the weak areas where you can work to make more profit.
